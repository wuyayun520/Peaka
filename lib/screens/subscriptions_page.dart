...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    DateTime expiry;
    if (purchaseDetails.productID == 'PeakaWeekVIP') {
      expiry = now.add(const Duration(days: 7));
    } else if (purchaseDetails.productID == 'PeakaMonthVIP') {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<_Privilege>> planPrivileges = [
      // Weekly
      [
        _Privilege(icon: Icons.sports, text: 'Unlimited browsing of works'),
        _Privilege(icon: Icons.block, text: 'Ad-free extreme sports experience'),
        _Privilege(icon: Icons.people, text: 'Unlimited modification of the avatar'),
      ],
      // Monthly
      [
        _Privilege(icon: Icons.sports, text: 'Unlimited browsing of works'),
        _Privilege(icon: Icons.support_agent, text: 'Unlimited consultation with AI advisors'),
        _Privilege(icon: Icons.block, text: 'Ad-free extreme sports experience'),
        _Privilege(icon: Icons.people, text: 'Unlimited modification of the avatar'),
      ],
    ];
                      ...
                      child: SafeArea(
                        child: Column(
                          ...
                          children: [
                            ...
                            // Subtitle
                            Text(
                              'Unlock the ultimate extreme sports experience',
                              style: TextStyle(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(16),
                                    border: Border.all(
                                      color: selected ? const Color(0xFF1976D2) : Colors.grey.withValues(alpha: 0.3),
                                      width: 2,
                                    ),
                                    boxShadow: [
                                      BoxShadow(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                '3. Tap Subscriptions\n'
                                '4. Find Extreme Premium in the list\n'
